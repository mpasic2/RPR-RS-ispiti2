...
public class GlavnaController {
    ...
    public TableColumn colGradLuka;
    ...
    public void initialize() {
        ...
        colGradLuka.setCellValueFactory(new PropertyValueFactory("luka"));
    }
    ...
    public void actionIzmijeniGrad(ActionEvent actionEvent) {
        ...
        try {
            ...
            stage.setResizable(true);
            stage.show();
            //stage.showAndWait(); OVO KAD STAVIS RADI ONO AL IMA PROBLEM DRUGI(NE PRIKAZUJE PROMJENE U REALNOM VREMENU TIPA IZMIJENIS BR STAN,
            // A ON OSTANE ISTI, AL U BAZI BUDE PORMJENA
